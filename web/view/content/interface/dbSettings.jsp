<div class="content-header">Database Settings</div>
...
<div class="content">
    <table>
        <tr>
            <td class="db-settings-1"> </td>
            <td class="db-settings-2">Username:</td>
            <td>musicxml</td>
        </tr>
        <tr>
            <td> </td>
            <td class="db-settings-2">Password:</td>
            <td>musicxml</td>
        </tr>
        <tr>
            <td> </td>
            <td class="db-settings-2">Database Name:</td>
            <td>musicxml</td>
        </tr>
        <tr>
            <td> </td>
            <td class="db-settings-2">Server:</td>
            <td>localhost</td>
        </tr>
        <tr>
            <td> </td>
            <td class="db-settings-2">Database Type:</td>
            <td>mysql</td>
        </tr>
    </table>
</div>
