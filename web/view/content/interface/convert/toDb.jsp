...
Only a MusicXML file can be converted to a MusicXML database record.
    ...
    <div class="content">
If no score name is entered in the text box, the filename will be the XML filename minus the file extension.
    </div>
...
No two scores stored in the database can have the same score name.
    ...
    <div class="content">
It's recommended that that SQL output be redirected to a file, or the amount of output may overwhelm the tool, requiring that it be restarted (do this under the "Output" tab in the tool).
    </div>
    </ul>
</div>
