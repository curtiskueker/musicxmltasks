<pre>
MUSICXMLVALIDATE(1)                                                                                                   User Commands                                                                                                  MUSICXMLVALIDATE(1)

NAME
       musicXmlValidate - manual page for musicXmlValidate 1.0

SYNOPSIS
       musicXmlValidate [INPUT_FILE]
...
SEE ALSO
       The full documentation for musicXmlValidate is maintained as a Texinfo manual.  If the info and musicXmlValidate programs are properly installed at your site, the command
              ...
              info musicXmlValidate

       should give you access to the complete manual.

musicXmlValidate 1.0                                                                                                   March 2021                                                                                                    MUSICXMLVALIDATE(1)
</pre>
